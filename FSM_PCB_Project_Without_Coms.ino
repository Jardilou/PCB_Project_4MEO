...
const int MQ135Pin = A0;    // MQ135 digital pin previously calibrated via the potentiometer
const int MiCS6814Pin_CO = A3;  // MiCS6814 analog pin
const int MiCS6814Pin_NO2 = A1; // MiCS6814 analog pin
const int MiCS6814Pin_NH3 = A2; // MiCS6814 analog pin
...
void detectingState() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    //int mq135Value =  mq135_sensor.getPPM(); //To calibrate for co2 values. Careful, it may take a long time
